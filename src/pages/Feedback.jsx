...
const Feedback = () => {
    ...
    return <>
        <Motion animate={{opacity:[0, 1]}} transition={{ duration: .7, easing: "ease-in-out" }}>
            ...
            <h3 className="text-base lg:text-lg xl:text-xl p-4 text-center font-poppins">We are happy to get your feedback :)</h3>
            ...
            <div className="flex flex-col gap-8 p-2 lg:p-8 xl:p-16 pb-28">
                <h3 class="text-center text-5xl w-full p-4 heavy-header">Feedbacks</h3>
                <hr />
